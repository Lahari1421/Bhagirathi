...
/** Floating WhatsApp CTA visible on every page. */
export function WhatsappFloat() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-3 rounded-full bg-[#25D366] py-3 pl-3 pr-4 text-white shadow-[0_10px_40px_-10px_rgba(37,211,102,0.7)] transition-all duration-300 hover:scale-105 hover:pr-5"
    >
